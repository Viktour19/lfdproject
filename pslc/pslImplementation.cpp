...
void init()
{
    ...
    for (int i = 0; i < MAXHYP; i++)
    {
        ...
        hypotheses[i].lhs = (Event_t *) malloc(sizeof(Event_t));
        hypotheses[i].rhs = (Event_t *) malloc(sizeof(Event_t));
...
Hypothesis newHyp()
{
    ...
    hyp.hits = 1;
    hyp.misses = 0;
    hyp.lhs =  (Event_t *) malloc(sizeof(Event_t));
    hyp.rhs =  (Event_t *) malloc(sizeof(Event_t));
